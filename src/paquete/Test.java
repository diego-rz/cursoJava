...
public class Test {
	public static void main(String args[]){
		...
		Auto a = new AutoEconomico("dodge" , "gtx", 1973, 150, true, false, false);
		miEmpresa.agregarVehiculo(a);
		a = new AutoDelujo("tesla", "v", 2016, 120, true, false, false);
		miEmpresa.agregarVehiculo(a);
		a = new AutoEstandar("chevrolet", "cruze", 2010, 90, true, true, false);
		miEmpresa.agregarVehiculo(a);
...
//			System.out.println(miEmpresa.getAutos()[i].tipo());
		...
		miEmpresa.getClientes()[1].nuevoAlquiler(miEmpresa.getAutos()[0], 7);
		miEmpresa.getClientes()[1].nuevoAlquiler(miEmpresa.getBarcos()[2], 15);
		miEmpresa.getClientes()[2].nuevoAlquiler(miEmpresa.getAutos()[1], 3);
